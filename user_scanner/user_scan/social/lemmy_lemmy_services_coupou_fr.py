...
def validate_lemmy_lemmy_services_coupou_fr(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://lemmy.services.coupou.fr/api/v3/user"
    show_url = f"https://lemmy.services.coupou.fr/u/{encoded_user}"
    headers = {
