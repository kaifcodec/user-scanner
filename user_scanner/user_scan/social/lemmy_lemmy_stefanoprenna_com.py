...
def validate_lemmy_lemmy_stefanoprenna_com(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://lemmy.stefanoprenna.com/api/v3/user"
    show_url = f"https://lemmy.stefanoprenna.com/u/{encoded_user}"
    headers = {
