...
def validate_lemmy_lundgrensjostrom(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://lemmy.lundgrensjostrom.com/api/v3/user"
    show_url = f"https://lemmy.lundgrensjostrom.com/u/{encoded_user}"
    headers = {
