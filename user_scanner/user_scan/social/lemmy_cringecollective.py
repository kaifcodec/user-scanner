...
def validate_lemmy_cringecollective(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://lemmy.cringecollective.io/api/v3/user"
    show_url = f"https://lemmy.cringecollective.io/u/{encoded_user}"
    headers = {
