...
def validate_lemmy_lemmy_randomsonicnet_org(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://lemmy.randomsonicnet.org/api/v3/user"
    show_url = f"https://lemmy.randomsonicnet.org/u/{encoded_user}"
    headers = {
