...
def validate_lemmy_lemmy_techtailors_net(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://lemmy.techtailors.net/api/v3/user"
    show_url = f"https://lemmy.techtailors.net/u/{encoded_user}"
    headers = {
