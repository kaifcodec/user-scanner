...
def validate_lemmy_lemmy_self_hosted_site(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://lemmy.self-hosted.site/api/v3/user"
    show_url = f"https://lemmy.self-hosted.site/u/{encoded_user}"
    headers = {
