...
def validate_bathandbodyworks(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://bathandbodyworks.miraheze.org/w/api.php"
    show_url = f"https://bathandbodyworks.miraheze.org/wiki/User:{encoded_user}"
    headers = {
