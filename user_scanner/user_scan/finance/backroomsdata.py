...
def validate_backroomsdata(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://backroomsdata.miraheze.org/w/api.php"
    show_url = f"https://backroomsdata.miraheze.org/wiki/User:{encoded_user}"
    headers = {
