...
def validate_aetheriumengine(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aetheriumengine.miraheze.org/w/api.php"
    show_url = f"https://aetheriumengine.miraheze.org/wiki/User:{encoded_user}"
    headers = {
