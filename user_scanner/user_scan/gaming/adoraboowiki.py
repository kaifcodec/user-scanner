...
def validate_adoraboowiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://adoraboowiki.miraheze.org/w/api.php"
    show_url = f"https://adoraboowiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
