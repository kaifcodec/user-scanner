...
def validate_site_3psfanmade(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://3psfanmade.miraheze.org/w/api.php"
    show_url = f"https://3psfanmade.miraheze.org/wiki/User:{encoded_user}"
    headers = {
