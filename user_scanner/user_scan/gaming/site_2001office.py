...
def validate_site_2001office(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://2001office.miraheze.org/w/api.php"
    show_url = f"https://2001office.miraheze.org/wiki/User:{encoded_user}"
    headers = {
