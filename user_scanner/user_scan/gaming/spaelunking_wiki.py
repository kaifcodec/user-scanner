...
def validate_spaelunking_wiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://10kfeetbelow.miraheze.org/w/api.php"
    show_url = f"https://10kfeetbelow.miraheze.org/wiki/User:{encoded_user}"
    headers = {
