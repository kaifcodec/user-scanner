...
def validate_accursedadventures(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://accursedadventures.miraheze.org/w/api.php"
    show_url = f"https://accursedadventures.miraheze.org/wiki/User:{encoded_user}"
    headers = {
