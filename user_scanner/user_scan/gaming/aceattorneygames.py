...
def validate_aceattorneygames(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aceattorneygames.miraheze.org/w/api.php"
    show_url = f"https://aceattorneygames.miraheze.org/wiki/User:{encoded_user}"
    headers = {
