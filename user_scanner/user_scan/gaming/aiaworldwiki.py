...
def validate_aiaworldwiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aiaworldwiki.miraheze.org/w/api.php"
    show_url = f"https://aiaworldwiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
