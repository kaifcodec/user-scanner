...
def validate_abyssexpedition(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://abyssexpedition.miraheze.org/w/api.php"
    show_url = f"https://abyssexpedition.miraheze.org/wiki/User:{encoded_user}"
    headers = {
