...
def validate_afterschoolcantata(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://afterschoolcantata.miraheze.org/w/api.php"
    show_url = f"https://afterschoolcantata.miraheze.org/wiki/User:{encoded_user}"
    headers = {
