...
def validate_abyssalsechoesofficial(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://abyssalsechoesofficial.miraheze.org/w/api.php"
    show_url = f"https://abyssalsechoesofficial.miraheze.org/wiki/User:{encoded_user}"
    headers = {
