...
def validate_abyssalsoulwiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://abyssalsoulwiki.miraheze.org/w/api.php"
    show_url = f"https://abyssalsoulwiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
