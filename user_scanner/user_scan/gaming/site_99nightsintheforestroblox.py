...
def validate_site_99nightsintheforestroblox(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://99nightsintheforestroblox.miraheze.org/w/api.php"
    show_url = f"https://99nightsintheforestroblox.miraheze.org/wiki/User:{encoded_user}"
    headers = {
