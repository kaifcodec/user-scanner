...
def validate_adventurecommunist(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://adventurecommunist.miraheze.org/w/api.php"
    show_url = f"https://adventurecommunist.miraheze.org/wiki/User:{encoded_user}"
    headers = {
