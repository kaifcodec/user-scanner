...
def validate_adventurehigh(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://adventurehigh.miraheze.org/w/api.php"
    show_url = f"https://adventurehigh.miraheze.org/wiki/User:{encoded_user}"
    headers = {
