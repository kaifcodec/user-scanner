...
def validate_agesofconflict(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://agesofconflict.miraheze.org/w/api.php"
    show_url = f"https://agesofconflict.miraheze.org/wiki/User:{encoded_user}"
    headers = {
