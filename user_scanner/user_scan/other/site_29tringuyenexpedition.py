...
def validate_site_29tringuyenexpedition(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://29tringuyenexpedition.miraheze.org/w/api.php"
    show_url = f"https://29tringuyenexpedition.miraheze.org/wiki/User:{encoded_user}"
    headers = {
