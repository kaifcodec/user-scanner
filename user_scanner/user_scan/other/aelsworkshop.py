...
def validate_aelsworkshop(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aelsworkshop.miraheze.org/w/api.php"
    show_url = f"https://aelsworkshop.miraheze.org/wiki/User:{encoded_user}"
    headers = {
