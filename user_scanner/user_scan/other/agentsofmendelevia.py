...
def validate_agentsofmendelevia(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://agentsofmendelevia.miraheze.org/w/api.php"
    show_url = f"https://agentsofmendelevia.miraheze.org/wiki/User:{encoded_user}"
    headers = {
