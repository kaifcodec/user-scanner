...
def validate_site_8b8tofficial(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://8b8tofficial.miraheze.org/w/api.php"
    show_url = f"https://8b8tofficial.miraheze.org/wiki/User:{encoded_user}"
    headers = {
