...
def validate_beyondlimits(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://beyondlimits.miraheze.org/w/api.php"
    show_url = f"https://beyondlimits.miraheze.org/wiki/User:{encoded_user}"
    headers = {
