...
def validate_biharplanningservice(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://biharplanningservice.miraheze.org/w/api.php"
    show_url = f"https://biharplanningservice.miraheze.org/wiki/User:{encoded_user}"
    headers = {
