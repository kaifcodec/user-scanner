...
def validate_axisveracommunity(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://axisveracommunity.miraheze.org/w/api.php"
    show_url = f"https://axisveracommunity.miraheze.org/wiki/User:{encoded_user}"
    headers = {
