...
def validate_ahleleleahlelaswiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://ahleleleahlelaswiki.miraheze.org/w/api.php"
    show_url = f"https://ahleleleahlelaswiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
