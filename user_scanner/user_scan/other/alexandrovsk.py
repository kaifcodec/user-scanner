...
def validate_alexandrovsk(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://alexandrovsk.miraheze.org/w/api.php"
    show_url = f"https://alexandrovsk.miraheze.org/wiki/User:{encoded_user}"
    headers = {
