...
def validate_backroomswikisw(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://backroomswikisw.miraheze.org/w/api.php"
    show_url = f"https://backroomswikisw.miraheze.org/wiki/User:{encoded_user}"
    headers = {
