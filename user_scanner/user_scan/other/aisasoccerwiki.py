...
def validate_aisasoccerwiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aisasoccerwiki.miraheze.org/w/api.php"
    show_url = f"https://aisasoccerwiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
