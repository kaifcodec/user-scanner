...
def validate_abravefrontier(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://abravefrontier.miraheze.org/w/api.php"
    show_url = f"https://abravefrontier.miraheze.org/wiki/User:{encoded_user}"
    headers = {
