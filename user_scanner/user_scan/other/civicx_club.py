...
def validate_civicx_club(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = f"https://civicx.club/u/{encoded_user}.json"
    show_url = f"https://civicx.club/u/{encoded_user}"
    headers = {
                ...
                if user_obj and isinstance(user_obj, dict) and user_obj.get("username"):
                    ...
                    if avatar_template:
                        ...
                        if avatar_url.startswith("/"):
                            avatar_url = f"https://civicx.club{avatar_url}"
