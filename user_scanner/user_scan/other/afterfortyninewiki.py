...
def validate_afterfortyninewiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://afterfortyninewiki.miraheze.org/w/api.php"
    show_url = f"https://afterfortyninewiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
