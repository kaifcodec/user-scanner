...
def validate_aethelgardia(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aethelgardia.miraheze.org/w/api.php"
    show_url = f"https://aethelgardia.miraheze.org/wiki/User:{encoded_user}"
    headers = {
