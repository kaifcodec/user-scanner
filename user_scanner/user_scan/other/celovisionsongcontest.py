...
def validate_celovisionsongcontest(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://celovisionsongcontest.miraheze.org/w/api.php"
    show_url = f"https://celovisionsongcontest.miraheze.org/wiki/User:{encoded_user}"
    headers = {
