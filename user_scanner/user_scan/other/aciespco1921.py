...
def validate_aciespco1921(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aciespco1921.miraheze.org/w/api.php"
    show_url = f"https://aciespco1921.miraheze.org/wiki/User:{encoded_user}"
    headers = {
