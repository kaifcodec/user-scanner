...
def validate_alexandercougarbattalion(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://alexandercougarbattalion.miraheze.org/w/api.php"
    show_url = f"https://alexandercougarbattalion.miraheze.org/wiki/User:{encoded_user}"
    headers = {
