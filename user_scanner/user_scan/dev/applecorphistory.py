...
def validate_applecorphistory(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://applecorphistory.miraheze.org/w/api.php"
    show_url = f"https://applecorphistory.miraheze.org/wiki/User:{encoded_user}"
    headers = {
