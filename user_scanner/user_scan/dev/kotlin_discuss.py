...
def validate_kotlin_discuss(user):
    url = f"https://discuss.kotlinlang.org/u/{user}.json"
    show_url = f"https://discuss.kotlinlang.org/u/{user}"
            ...
            if u:
                ...
                if avatar:
                    ...
                    if avatar.startswith("/"):
                        avatar = "https://discuss.kotlinlang.org" + avatar
                    extra["avatar"] = avatar
