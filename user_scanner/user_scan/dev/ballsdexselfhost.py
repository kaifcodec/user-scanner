...
def validate_ballsdexselfhost(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://ballsdexselfhost.miraheze.org/w/api.php"
    show_url = f"https://ballsdexselfhost.miraheze.org/wiki/User:{encoded_user}"
    headers = {
