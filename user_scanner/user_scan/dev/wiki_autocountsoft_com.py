...
def validate_wiki_autocountsoft_com(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://wiki.autocountsoft.com/w/api.php"
    show_url = f"https://wiki.autocountsoft.com/wiki/User:{encoded_user}"
    headers = {
