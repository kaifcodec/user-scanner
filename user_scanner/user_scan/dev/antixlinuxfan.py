...
def validate_antixlinuxfan(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://antixlinuxfan.miraheze.org/w/api.php"
    show_url = f"https://antixlinuxfan.miraheze.org/wiki/User:{encoded_user}"
    headers = {
