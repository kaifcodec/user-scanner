...
def validate_rust_users(user):
    url = f"https://users.rust-lang.org/u/{user}.json"
    show_url = f"https://users.rust-lang.org/u/{user}"
            ...
            if u:
                ...
                if avatar:
                    ...
                    if avatar.startswith("/"):
                        avatar = "https://users.rust-lang.org" + avatar
                    extra["avatar"] = avatar
