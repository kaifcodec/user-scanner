...
def validate_baldisbasicsplusmodding(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://baldisbasicsplusmodding.miraheze.org/w/api.php"
    show_url = f"https://baldisbasicsplusmodding.miraheze.org/wiki/User:{encoded_user}"
    headers = {
