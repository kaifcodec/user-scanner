...
def validate_bootstrapping(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://bootstrapping.miraheze.org/w/api.php"
    show_url = f"https://bootstrapping.miraheze.org/wiki/User:{encoded_user}"
    headers = {
