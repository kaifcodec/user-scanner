...
def validate_blockcodingos(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://blockcodingos.miraheze.org/w/api.php"
    show_url = f"https://blockcodingos.miraheze.org/wiki/User:{encoded_user}"
    headers = {
