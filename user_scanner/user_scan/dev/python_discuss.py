...
def validate_python_discuss(user):
    url = f"https://discuss.python.org/u/{user}.json"
    show_url = f"https://discuss.python.org/u/{user}"
            ...
            if u:
                ...
                if avatar:
                    ...
                    if avatar.startswith("/"):
                        avatar = "https://discuss.python.org" + avatar
                    extra["avatar"] = avatar
