...
def validate_wiki_caspergaming_com(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://wiki.caspergaming.com/w/api.php"
    show_url = f"https://wiki.caspergaming.com/wiki/User:{encoded_user}"
    headers = {
