...
def validate_androidvariants(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://androidvariants.miraheze.org/w/api.php"
    show_url = f"https://androidvariants.miraheze.org/wiki/User:{encoded_user}"
    headers = {
