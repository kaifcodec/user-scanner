...
def validate_brutalorchestramodding(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://brutalorchestramodding.miraheze.org/w/api.php"
    show_url = f"https://brutalorchestramodding.miraheze.org/wiki/User:{encoded_user}"
    headers = {
