...
def validate_wiki_freesoftwarecaucus_org(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://wiki.freesoftwarecaucus.org/w/api.php"
    show_url = f"https://wiki.freesoftwarecaucus.org/wiki/User:{encoded_user}"
    headers = {
