...
def validate_casiohacking(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://casiohacking.miraheze.org/w/api.php"
    show_url = f"https://casiohacking.miraheze.org/wiki/User:{encoded_user}"
    headers = {
