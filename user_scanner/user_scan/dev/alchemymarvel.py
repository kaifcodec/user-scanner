...
def validate_alchemymarvel(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://alchemymarvel.miraheze.org/w/api.php"
    show_url = f"https://alchemymarvel.miraheze.org/wiki/User:{encoded_user}"
    headers = {
