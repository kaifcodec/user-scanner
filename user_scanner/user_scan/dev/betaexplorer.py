...
def validate_betaexplorer(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://betaexplorer.miraheze.org/w/api.php"
    show_url = f"https://betaexplorer.miraheze.org/wiki/User:{encoded_user}"
    headers = {
