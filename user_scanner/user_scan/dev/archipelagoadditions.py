...
def validate_archipelagoadditions(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://archipelagoadditions.miraheze.org/w/api.php"
    show_url = f"https://archipelagoadditions.miraheze.org/wiki/User:{encoded_user}"
    headers = {
