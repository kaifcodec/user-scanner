...
def validate_aimingforall(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aimingforall.miraheze.org/w/api.php"
    show_url = f"https://aimingforall.miraheze.org/wiki/User:{encoded_user}"
    headers = {
