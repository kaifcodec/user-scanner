...
def validate_aloudeclipse(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aloudeclipse.miraheze.org/w/api.php"
    show_url = f"https://aloudeclipse.miraheze.org/wiki/User:{encoded_user}"
    headers = {
