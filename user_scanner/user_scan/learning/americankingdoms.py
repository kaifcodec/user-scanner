...
def validate_americankingdoms(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://americankingdoms.miraheze.org/w/api.php"
    show_url = f"https://americankingdoms.miraheze.org/wiki/User:{encoded_user}"
    headers = {
