...
def validate_andybriggsinventory(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://andybriggsinventory.miraheze.org/w/api.php"
    show_url = f"https://andybriggsinventory.miraheze.org/wiki/User:{encoded_user}"
    headers = {
