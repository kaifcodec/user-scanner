...
def validate_two_color_series(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://2colorseries.miraheze.org/w/api.php"
    show_url = f"https://2colorseries.miraheze.org/wiki/User:{encoded_user}"
    headers = {
