...
def validate_alienbiospheres(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://alienbiospheres.miraheze.org/w/api.php"
    show_url = f"https://alienbiospheres.miraheze.org/wiki/User:{encoded_user}"
    headers = {
