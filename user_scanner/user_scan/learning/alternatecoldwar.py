...
def validate_alternatecoldwar(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://alternatecoldwar.miraheze.org/w/api.php"
    show_url = f"https://alternatecoldwar.miraheze.org/wiki/User:{encoded_user}"
    headers = {
