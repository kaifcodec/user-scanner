...
def validate_antiquitytomodernity(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://antiquitytomodernity.miraheze.org/w/api.php"
    show_url = f"https://antiquitytomodernity.miraheze.org/wiki/User:{encoded_user}"
    headers = {
