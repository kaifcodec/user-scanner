...
def validate_anthronianheroes(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://anthronianheroes.miraheze.org/w/api.php"
    show_url = f"https://anthronianheroes.miraheze.org/wiki/User:{encoded_user}"
    headers = {
