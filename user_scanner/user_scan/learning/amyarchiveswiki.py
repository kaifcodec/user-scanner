...
def validate_amyarchiveswiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://amyarchiveswiki.miraheze.org/w/api.php"
    show_url = f"https://amyarchiveswiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
