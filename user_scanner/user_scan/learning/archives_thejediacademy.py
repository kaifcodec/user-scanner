...
def validate_archives_thejediacademy(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://archives.thejediacademy.net/api.php"
    show_url = f"https://archives.thejediacademy.net/wiki/User:{encoded_user}"
    headers = {
