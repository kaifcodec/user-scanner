...
def validate_allbirdswiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://allbirdswiki.miraheze.org/w/api.php"
    show_url = f"https://allbirdswiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
