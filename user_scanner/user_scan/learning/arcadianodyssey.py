...
def validate_arcadianodyssey(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://arcadianodyssey.miraheze.org/w/api.php"
    show_url = f"https://arcadianodyssey.miraheze.org/wiki/User:{encoded_user}"
    headers = {
