...
def validate_altbyzantine(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://altbyzantine.miraheze.org/w/api.php"
    show_url = f"https://altbyzantine.miraheze.org/wiki/User:{encoded_user}"
    headers = {
