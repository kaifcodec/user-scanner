...
def validate_angleseconlang(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://angleseconlang.miraheze.org/w/api.php"
    show_url = f"https://angleseconlang.miraheze.org/wiki/User:{encoded_user}"
    headers = {
