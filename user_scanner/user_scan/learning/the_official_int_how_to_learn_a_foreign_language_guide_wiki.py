...
def validate_the_official_int_how_to_learn_a_foreign_language_guide_wiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://4chanint.miraheze.org/w/api.php"
    show_url = f"https://4chanint.miraheze.org/wiki/User:{encoded_user}"
    headers = {
