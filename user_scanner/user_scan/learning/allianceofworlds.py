...
def validate_allianceofworlds(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://allianceofworlds.miraheze.org/w/api.php"
    show_url = f"https://allianceofworlds.miraheze.org/wiki/User:{encoded_user}"
    headers = {
