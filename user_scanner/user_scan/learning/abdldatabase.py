...
def validate_abdldatabase(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://abdldatabase.miraheze.org/w/api.php"
    show_url = f"https://abdldatabase.miraheze.org/wiki/User:{encoded_user}"
    headers = {
