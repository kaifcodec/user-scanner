...
def validate_aegisfoundation(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aegisfoundation.miraheze.org/w/api.php"
    show_url = f"https://aegisfoundation.miraheze.org/wiki/User:{encoded_user}"
    headers = {
