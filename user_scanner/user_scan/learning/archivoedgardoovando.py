...
def validate_archivoedgardoovando(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://archivoedgardoovando.miraheze.org/w/api.php"
    show_url = f"https://archivoedgardoovando.miraheze.org/wiki/User:{encoded_user}"
    headers = {
