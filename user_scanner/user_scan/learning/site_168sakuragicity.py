...
def validate_site_168sakuragicity(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://168sakuragicity.miraheze.org/w/api.php"
    show_url = f"https://168sakuragicity.miraheze.org/wiki/User:{encoded_user}"
    headers = {
