...
def validate_agercaeligalaxysnrp(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://agercaeligalaxysnrp.miraheze.org/w/api.php"
    show_url = f"https://agercaeligalaxysnrp.miraheze.org/wiki/User:{encoded_user}"
    headers = {
