...
def validate_aikarebirthfanfic(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aikarebirthfanfic.miraheze.org/w/api.php"
    show_url = f"https://aikarebirthfanfic.miraheze.org/wiki/User:{encoded_user}"
    headers = {
