...
def validate_angelsdestiny(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://angelsdestiny.miraheze.org/w/api.php"
    show_url = f"https://angelsdestiny.miraheze.org/wiki/User:{encoded_user}"
    headers = {
