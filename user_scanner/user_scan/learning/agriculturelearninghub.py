...
def validate_agriculturelearninghub(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://agriculturelearninghub.miraheze.org/w/api.php"
    show_url = f"https://agriculturelearninghub.miraheze.org/wiki/User:{encoded_user}"
    headers = {
