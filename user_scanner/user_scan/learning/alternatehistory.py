...
def validate_alternatehistory(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://alternatehistory.miraheze.org/w/api.php"
    show_url = f"https://alternatehistory.miraheze.org/wiki/User:{encoded_user}"
    headers = {
