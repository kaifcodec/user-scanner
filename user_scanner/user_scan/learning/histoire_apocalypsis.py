...
def validate_histoire_apocalypsis(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://histoire.apocalypsis.org/api.php"
    show_url = f"https://histoire.apocalypsis.org/wiki/User:{encoded_user}"
    headers = {
