...
def validate_althistorypobeda(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://althistorypobeda.miraheze.org/w/api.php"
    show_url = f"https://althistorypobeda.miraheze.org/wiki/User:{encoded_user}"
    headers = {
