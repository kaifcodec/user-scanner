...
def validate_aftertherevolution(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aftertherevolution.miraheze.org/w/api.php"
    show_url = f"https://aftertherevolution.miraheze.org/wiki/User:{encoded_user}"
    headers = {
