...
def validate_aftertheflashwintertide(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aftertheflashwintertide.miraheze.org/w/api.php"
    show_url = f"https://aftertheflashwintertide.miraheze.org/wiki/User:{encoded_user}"
    headers = {
