...
def validate_aimlessandwandering(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aimlessandwandering.miraheze.org/w/api.php"
    show_url = f"https://aimlessandwandering.miraheze.org/wiki/User:{encoded_user}"
    headers = {
