...
def validate_activemockgovernments(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://activemockgovernments.miraheze.org/w/api.php"
    show_url = f"https://activemockgovernments.miraheze.org/wiki/User:{encoded_user}"
    headers = {
