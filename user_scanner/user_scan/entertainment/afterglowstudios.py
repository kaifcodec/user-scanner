...
def validate_afterglowstudios(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://afterglowstudios.miraheze.org/w/api.php"
    show_url = f"https://afterglowstudios.miraheze.org/wiki/User:{encoded_user}"
    headers = {
