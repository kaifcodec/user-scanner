...
def validate_acquisitionsincorporated(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://acquisitionsincorporated.miraheze.org/w/api.php"
    show_url = f"https://acquisitionsincorporated.miraheze.org/wiki/User:{encoded_user}"
    headers = {
