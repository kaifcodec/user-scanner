...
def validate_adventureisnigh(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://adventureisnigh.miraheze.org/w/api.php"
    show_url = f"https://adventureisnigh.miraheze.org/wiki/User:{encoded_user}"
    headers = {
