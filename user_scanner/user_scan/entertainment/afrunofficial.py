...
def validate_afrunofficial(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://afrunofficial.miraheze.org/w/api.php"
    show_url = f"https://afrunofficial.miraheze.org/wiki/User:{encoded_user}"
    headers = {
