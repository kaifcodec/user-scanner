...
def validate_the_hydrogeneth_planet_encyclopedia(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://2026hydrogenethplanet.miraheze.org/w/api.php"
    show_url = f"https://2026hydrogenethplanet.miraheze.org/wiki/User:{encoded_user}"
    headers = {
