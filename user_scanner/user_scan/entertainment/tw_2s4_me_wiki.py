...
def validate_tw_2s4_me_wiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://2s4textwall.miraheze.org/w/api.php"
    show_url = f"https://2s4textwall.miraheze.org/wiki/User:{encoded_user}"
    headers = {
