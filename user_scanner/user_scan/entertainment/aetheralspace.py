...
def validate_aetheralspace(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aetheralspace.miraheze.org/w/api.php"
    show_url = f"https://aetheralspace.miraheze.org/wiki/User:{encoded_user}"
    headers = {
