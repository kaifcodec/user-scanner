...
def validate_site_2cool4scool(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://2cool4scool.miraheze.org/w/api.php"
    show_url = f"https://2cool4scool.miraheze.org/wiki/User:{encoded_user}"
    headers = {
