...
def validate_acompletelynormalmallwiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://acompletelynormalmallwiki.miraheze.org/w/api.php"
    show_url = f"https://acompletelynormalmallwiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
