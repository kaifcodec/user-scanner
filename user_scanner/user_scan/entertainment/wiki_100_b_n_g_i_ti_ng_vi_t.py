...
def validate_wiki_100_b_n_g_i_ti_ng_vi_t(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://100bangai.songngu.xyz/w/api.php"
    show_url = f"https://100bangai.songngu.xyz/wiki/User:{encoded_user}"
    headers = {
