...
def validate_aceattorneycirclejerk(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aceattorneycirclejerk.miraheze.org/w/api.php"
    show_url = f"https://aceattorneycirclejerk.miraheze.org/wiki/User:{encoded_user}"
    headers = {
