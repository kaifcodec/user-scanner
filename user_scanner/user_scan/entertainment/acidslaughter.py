...
def validate_acidslaughter(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://acidslaughter.miraheze.org/w/api.php"
    show_url = f"https://acidslaughter.miraheze.org/wiki/User:{encoded_user}"
    headers = {
