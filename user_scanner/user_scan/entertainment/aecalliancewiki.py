...
def validate_aecalliancewiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aecalliancewiki.miraheze.org/w/api.php"
    show_url = f"https://aecalliancewiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
