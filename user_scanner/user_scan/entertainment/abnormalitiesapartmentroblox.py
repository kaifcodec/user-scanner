...
def validate_abnormalitiesapartmentroblox(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://abnormalitiesapartmentroblox.miraheze.org/w/api.php"
    show_url = f"https://abnormalitiesapartmentroblox.miraheze.org/wiki/User:{encoded_user}"
    headers = {
