...
def validate_advisorsconcept(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://advisorsconcept.miraheze.org/w/api.php"
    show_url = f"https://advisorsconcept.miraheze.org/wiki/User:{encoded_user}"
    headers = {
