...
def validate_viteboka_studentersamfundet_no(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://viteboka.studentersamfundet.no/w/api.php"
    show_url = f"https://viteboka.studentersamfundet.no/wiki/User:{encoded_user}"
    headers = {
