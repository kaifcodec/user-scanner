...
def validate_actingwithtech(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://actingwithtech.miraheze.org/w/api.php"
    show_url = f"https://actingwithtech.miraheze.org/wiki/User:{encoded_user}"
    headers = {
