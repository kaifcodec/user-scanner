...
def validate_site_100applianceparts(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://100applianceparts.miraheze.org/w/api.php"
    show_url = f"https://100applianceparts.miraheze.org/wiki/User:{encoded_user}"
    headers = {
