...
def validate_freeopensourcesoftware(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://freeopensourcesoftware.org/api.php"
    show_url = f"https://freeopensourcesoftware.org/wiki/User:{encoded_user}"
    headers = {
