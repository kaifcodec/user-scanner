...
def validate_anythingdexofficial(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://anythingdexofficial.miraheze.org/w/api.php"
    show_url = f"https://anythingdexofficial.miraheze.org/wiki/User:{encoded_user}"
    headers = {
