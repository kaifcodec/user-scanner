...
def validate_en_publicdomainproject(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://en.publicdomainproject.org/api.php"
    show_url = f"https://en.publicdomainproject.org/wiki/User:{encoded_user}"
    headers = {
