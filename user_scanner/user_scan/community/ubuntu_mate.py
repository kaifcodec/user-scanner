...
def validate_ubuntu_mate(user):
    url = f"https://ubuntu-mate.community/u/{user}.json"
    show_url = f"https://ubuntu-mate.community/u/{user}"
            ...
            if u:
                ...
                if avatar:
                    ...
                    if avatar.startswith("/"):
                        avatar = "https://ubuntu-mate.community" + avatar
                    extra["avatar"] = avatar
