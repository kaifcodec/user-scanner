...
def validate_anomalicorporation(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://anomalicorporation.miraheze.org/w/api.php"
    show_url = f"https://anomalicorporation.miraheze.org/wiki/User:{encoded_user}"
    headers = {
