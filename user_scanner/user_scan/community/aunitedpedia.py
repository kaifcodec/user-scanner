...
def validate_aunitedpedia(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aunitedpedia.miraheze.org/w/api.php"
    show_url = f"https://aunitedpedia.miraheze.org/wiki/User:{encoded_user}"
    headers = {
