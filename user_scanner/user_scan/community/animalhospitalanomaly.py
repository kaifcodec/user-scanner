...
def validate_animalhospitalanomaly(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://animalhospitalanomaly.miraheze.org/w/api.php"
    show_url = f"https://animalhospitalanomaly.miraheze.org/wiki/User:{encoded_user}"
    headers = {
