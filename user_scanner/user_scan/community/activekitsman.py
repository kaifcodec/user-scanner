...
def validate_activekitsman(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://activekitsman.miraheze.org/w/api.php"
    show_url = f"https://activekitsman.miraheze.org/wiki/User:{encoded_user}"
    headers = {
