...
def validate_rt_wiki_bestpractical(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://rt-wiki.bestpractical.com/api.php"
    show_url = f"https://rt-wiki.bestpractical.com/wiki/User:{encoded_user}"
    headers = {
