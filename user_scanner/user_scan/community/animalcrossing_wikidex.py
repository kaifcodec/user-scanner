...
def validate_animalcrossing_wikidex(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://animalcrossing.wikidex.net/api.php"
    show_url = f"https://animalcrossing.wikidex.net/wiki/User:{encoded_user}"
    headers = {
