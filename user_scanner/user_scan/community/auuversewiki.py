...
def validate_auuversewiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://auuversewiki.miraheze.org/w/api.php"
    show_url = f"https://auuversewiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
