...
def validate_leksykonkultury_ceik_eu(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://leksykonkultury.ceik.eu/api.php"
    show_url = f"https://leksykonkultury.ceik.eu/wiki/User:{encoded_user}"
    headers = {
