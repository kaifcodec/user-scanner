...
def validate_aryavratpedia(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aryavratpedia.miraheze.org/w/api.php"
    show_url = f"https://aryavratpedia.miraheze.org/wiki/User:{encoded_user}"
    headers = {
