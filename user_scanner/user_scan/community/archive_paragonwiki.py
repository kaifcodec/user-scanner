...
def validate_archive_paragonwiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://archive.paragonwiki.com/w/api.php"
    show_url = f"https://archive.paragonwiki.com/wiki/User:{encoded_user}"
    headers = {
