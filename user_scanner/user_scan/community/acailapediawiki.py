...
def validate_acailapediawiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://acailapediawiki.miraheze.org/w/api.php"
    show_url = f"https://acailapediawiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
