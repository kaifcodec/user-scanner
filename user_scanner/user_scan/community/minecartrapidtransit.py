...
def validate_minecartrapidtransit(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://wiki.minecartrapidtransit.net/api.php"
    show_url = f"https://wiki.minecartrapidtransit.net/wiki/User:{encoded_user}"
    headers = {
