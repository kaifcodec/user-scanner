...
def validate_altcyclopedia(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://altcyclopedia.miraheze.org/w/api.php"
    show_url = f"https://altcyclopedia.miraheze.org/wiki/User:{encoded_user}"
    headers = {
