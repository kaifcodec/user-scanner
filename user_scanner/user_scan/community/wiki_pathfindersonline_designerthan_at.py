...
def validate_wiki_pathfindersonline_designerthan_at(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://wiki-pathfindersonline.designerthan.at/api.php"
    show_url = f"https://wiki-pathfindersonline.designerthan.at/wiki/User:{encoded_user}"
    headers = {
