...
def validate_site_1857ironcountymilitia(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://1857ironcountymilitia.com/api.php"
    show_url = f"https://1857ironcountymilitia.com/wiki/User:{encoded_user}"
    headers = {
