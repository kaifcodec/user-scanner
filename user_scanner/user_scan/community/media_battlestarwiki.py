...
def validate_media_battlestarwiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://media.battlestarwiki.org/w/api.php"
    show_url = f"https://media.battlestarwiki.org/wiki/User:{encoded_user}"
    headers = {
