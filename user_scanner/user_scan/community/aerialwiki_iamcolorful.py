...
def validate_aerialwiki_iamcolorful(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aerialwiki.iamcolorful.com/api.php"
    show_url = f"https://aerialwiki.iamcolorful.com/wiki/User:{encoded_user}"
    headers = {
