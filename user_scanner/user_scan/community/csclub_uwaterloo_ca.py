...
def validate_csclub_uwaterloo_ca(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://wiki.csclub.uwaterloo.ca/api.php"
    show_url = f"https://wiki.csclub.uwaterloo.ca/wiki/User:{encoded_user}"
    headers = {
