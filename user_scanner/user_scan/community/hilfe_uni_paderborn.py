...
def validate_hilfe_uni_paderborn(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://hilfe.uni-paderborn.de/api.php"
    show_url = f"https://hilfe.uni-paderborn.de/wiki/User:{encoded_user}"
    headers = {
