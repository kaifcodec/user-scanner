...
def validate_aucklandtransport(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aucklandtransport.miraheze.org/w/api.php"
    show_url = f"https://aucklandtransport.miraheze.org/wiki/User:{encoded_user}"
    headers = {
