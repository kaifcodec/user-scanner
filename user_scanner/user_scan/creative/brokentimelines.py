...
def validate_brokentimelines(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://brokentimelines.miraheze.org/w/api.php"
    show_url = f"https://brokentimelines.miraheze.org/wiki/User:{encoded_user}"
    headers = {
