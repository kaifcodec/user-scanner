...
def validate_aquaticanarchy(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://aquaticanarchy.miraheze.org/w/api.php"
    show_url = f"https://aquaticanarchy.miraheze.org/wiki/User:{encoded_user}"
    headers = {
