...
def validate_captainshelleye(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://captainshelleye.miraheze.org/w/api.php"
    show_url = f"https://captainshelleye.miraheze.org/wiki/User:{encoded_user}"
    headers = {
