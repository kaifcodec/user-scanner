...
def validate_brockvillerailfan(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://brockvillerailfan.miraheze.org/w/api.php"
    show_url = f"https://brockvillerailfan.miraheze.org/wiki/User:{encoded_user}"
    headers = {
