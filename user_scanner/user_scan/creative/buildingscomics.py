...
def validate_buildingscomics(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://buildingscomics.miraheze.org/w/api.php"
    show_url = f"https://buildingscomics.miraheze.org/wiki/User:{encoded_user}"
    headers = {
