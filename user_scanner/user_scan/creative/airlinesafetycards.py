...
def validate_airlinesafetycards(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://airlinesafetycards.miraheze.org/w/api.php"
    show_url = f"https://airlinesafetycards.miraheze.org/wiki/User:{encoded_user}"
    headers = {
