...
def validate_anticipatorydesign(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://anticipatorydesign.miraheze.org/w/api.php"
    show_url = f"https://anticipatorydesign.miraheze.org/wiki/User:{encoded_user}"
    headers = {
