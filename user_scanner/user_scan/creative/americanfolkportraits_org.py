...
def validate_americanfolkportraits_org(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://americanfolkportraits.org/w/api.php"
    show_url = f"https://americanfolkportraits.org/wiki/User:{encoded_user}"
    headers = {
