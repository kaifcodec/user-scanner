...
def validate_patternlibrary_austinstorm_com(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://patternlibrary.austinstorm.com/w/api.php"
    show_url = f"https://patternlibrary.austinstorm.com/wiki/User:{encoded_user}"
    headers = {
