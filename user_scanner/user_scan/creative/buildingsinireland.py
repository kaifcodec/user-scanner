...
def validate_buildingsinireland(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://buildingsinireland.miraheze.org/w/api.php"
    show_url = f"https://buildingsinireland.miraheze.org/wiki/User:{encoded_user}"
    headers = {
