...
def validate_architecture(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://architecture.miraheze.org/w/api.php"
    show_url = f"https://architecture.miraheze.org/wiki/User:{encoded_user}"
    headers = {
