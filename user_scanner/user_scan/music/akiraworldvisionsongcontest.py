...
def validate_akiraworldvisionsongcontest(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://akiraworldvisionsongcontest.miraheze.org/w/api.php"
    show_url = f"https://akiraworldvisionsongcontest.miraheze.org/wiki/User:{encoded_user}"
    headers = {
