...
def validate_site_4chanmusic(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://4chanmusic.miraheze.org/w/api.php"
    show_url = f"https://4chanmusic.miraheze.org/wiki/User:{encoded_user}"
    headers = {
