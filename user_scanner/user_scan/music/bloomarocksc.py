...
def validate_bloomarocksc(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://bloomarocksc.miraheze.org/w/api.php"
    show_url = f"https://bloomarocksc.miraheze.org/wiki/User:{encoded_user}"
    headers = {
