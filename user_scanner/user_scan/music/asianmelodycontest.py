...
def validate_asianmelodycontest(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://asianmelodycontest.miraheze.org/w/api.php"
    show_url = f"https://asianmelodycontest.miraheze.org/wiki/User:{encoded_user}"
    headers = {
