...
def validate_alphasongcontest(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://alphasongcontest.miraheze.org/w/api.php"
    show_url = f"https://alphasongcontest.miraheze.org/wiki/User:{encoded_user}"
    headers = {
