...
def validate_amnhacvietnam(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://amnhacvietnam.miraheze.org/w/api.php"
    show_url = f"https://amnhacvietnam.miraheze.org/wiki/User:{encoded_user}"
    headers = {
