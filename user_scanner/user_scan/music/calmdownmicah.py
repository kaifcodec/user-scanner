...
def validate_calmdownmicah(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://calmdownmicah.miraheze.org/w/api.php"
    show_url = f"https://calmdownmicah.miraheze.org/wiki/User:{encoded_user}"
    headers = {
