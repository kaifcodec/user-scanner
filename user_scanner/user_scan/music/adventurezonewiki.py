...
def validate_adventurezonewiki(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://adventurezonewiki.miraheze.org/w/api.php"
    show_url = f"https://adventurezonewiki.miraheze.org/wiki/User:{encoded_user}"
    headers = {
