...
def validate_astraonlinecontest(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://astraonlinecontest.miraheze.org/w/api.php"
    show_url = f"https://astraonlinecontest.miraheze.org/wiki/User:{encoded_user}"
    headers = {
