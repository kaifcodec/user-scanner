...
def validate_australianbands(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://australianbands.miraheze.org/w/api.php"
    show_url = f"https://australianbands.miraheze.org/wiki/User:{encoded_user}"
    headers = {
