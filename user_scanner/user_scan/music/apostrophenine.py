...
def validate_apostrophenine(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://apostrophenine.miraheze.org/w/api.php"
    show_url = f"https://apostrophenine.miraheze.org/wiki/User:{encoded_user}"
    headers = {
