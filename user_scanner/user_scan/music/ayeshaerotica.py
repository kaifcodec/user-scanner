...
def validate_ayeshaerotica(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://ayeshaerotica.miraheze.org/w/api.php"
    show_url = f"https://ayeshaerotica.miraheze.org/wiki/User:{encoded_user}"
    headers = {
