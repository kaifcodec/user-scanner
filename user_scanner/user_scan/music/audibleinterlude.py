...
def validate_audibleinterlude(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://audibleinterlude.miraheze.org/w/api.php"
    show_url = f"https://audibleinterlude.miraheze.org/wiki/User:{encoded_user}"
    headers = {
