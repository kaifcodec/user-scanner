...
def validate_bestievision(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://bestievision.miraheze.org/w/api.php"
    show_url = f"https://bestievision.miraheze.org/wiki/User:{encoded_user}"
    headers = {
