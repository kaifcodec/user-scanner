...
def validate_bashervision(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://bashervision.miraheze.org/w/api.php"
    show_url = f"https://bashervision.miraheze.org/wiki/User:{encoded_user}"
    headers = {
