...
def validate_alexissongcontests(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://alexissongcontests.miraheze.org/w/api.php"
    show_url = f"https://alexissongcontests.miraheze.org/wiki/User:{encoded_user}"
    headers = {
