...
def validate_ambientsongcontest(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://ambientsongcontest.miraheze.org/w/api.php"
    show_url = f"https://ambientsongcontest.miraheze.org/wiki/User:{encoded_user}"
    headers = {
