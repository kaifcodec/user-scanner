...
def validate_calimasphere(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://calimasphere.miraheze.org/w/api.php"
    show_url = f"https://calimasphere.miraheze.org/wiki/User:{encoded_user}"
    headers = {
