...
def validate_amoursongcontest(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://amoursongcontest.miraheze.org/w/api.php"
    show_url = f"https://amoursongcontest.miraheze.org/wiki/User:{encoded_user}"
    headers = {
