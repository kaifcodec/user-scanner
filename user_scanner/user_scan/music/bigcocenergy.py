...
def validate_bigcocenergy(user: str) -> Result:
    encoded_user = urllib.parse.quote(user)
    url = "https://bigcocenergy.miraheze.org/w/api.php"
    show_url = f"https://bigcocenergy.miraheze.org/wiki/User:{encoded_user}"
    headers = {
